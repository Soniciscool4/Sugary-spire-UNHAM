if ((obj_player.state == (0 << 0) || obj_player.state == (65 << 0) || obj_player.state == (66 << 0) || obj_player.state == (67 << 0) || obj_player.state == (61 << 0)) && obj_player.key_up && obj_player.grounded && global.rudejanitor == 1 && image_index == 0 && place_meeting(x, y, obj_player))
{
