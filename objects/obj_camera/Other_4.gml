...
if (instance_exists(obj_player) && obj_player.state != (28 << 0) && obj_player.state != (48 << 0))
{
    ...
    var _shake_x = 0
    var _shake_y = 0
    if (obj_player.state == (67 << 0) || (obj_player.state == (98 << 0) && obj_player.movespeed > 10) || obj_player.state == (29 << 0))
    {
