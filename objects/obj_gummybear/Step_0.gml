...
switch sprite_get_name(startspr)
{
    ...
    case "spr_gummybearMcoffee":
        switch state
        {
            case (0 << 0):
                ...
                if (obj_player.state == (43 << 0) && point_in_camera(x, y, view_camera[0]) && obj_player.sprite_index == obj_player.spr_player_taunt)
                {
    ...
    case "spr_gummybear_paper":
        ...
        {
            case (0 << 0):
                if (obj_player.state == (43 << 0) && point_in_camera(x, y, view_camera[0]) && obj_player.sprite_index == obj_player.spr_player_taunt && sprite_index != spr_gummybear_papertauntpanic)
                {
                    goalsprite = sprite_index
                    if global.panic
                    {
            ...
            case (1 << 0):
                ...
                if (obj_player.state != (43 << 0) && (!global.panic))
                {
                    state = (0 << 0)
                    hsp = goalhsp
                    vsp = goalvsp
