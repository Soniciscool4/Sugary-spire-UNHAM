...
char_select = 1
prevcharselect = 1
unlock_pizzano = function(argument0) //anon@316@gml_Object_obj_mainfartselect_Create_0
{
...
showpizzano = 0
menuindex = 0
delete_emptysave = function(argument0) //anon@902@gml_Object_obj_mainfartselect_Create_0
{
    ini_open(argument0)
