function cutscene_rosetteMines_prestart() //cutscene_rosetteMines_prestart
{
    static diveBuffer = 0
    ...
    with (obj_player)
    {
        if grounded
        {
            ...
            if (state == (67 << 0) || ((state == (66 << 0) || state == (29 << 0) || state == (64 << 0)) && movespeed >= 8))
            {
        ...
        {
            if (state != (57 << 0) && state != (105 << 0))
            {
                if (state != (15 << 0) && state != (71 << 0) && state != (50 << 0))
                {
                    if (state == (66 << 0) || state == (102 << 0) || state == (102 << 0))
                    {
                        static diveBuffer = irandom_range(2, 6)
...
function cutscene_rosetteMines_start() //cutscene_rosetteMines_start
{
    var finished = false
...
function cutscene_rosetteMines_middle() //cutscene_rosetteMines_middle
{
    var finished = false
    with (obj_player)
    {
...
function cutscene_rosetteMines_grab() //cutscene_rosetteMines_grab
{
    var finished = false
    with (obj_player)
    {
...
function cutscene_rosetteMines_end() //cutscene_rosetteMines_end
{
    global.treat = true
    with (obj_player)
        state = (0 << 0)
