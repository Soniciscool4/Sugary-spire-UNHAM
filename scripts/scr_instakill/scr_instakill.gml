function scr_instakill() //scr_instakill
{
    ...
    if (other.baddieID.state == (19 << 0))
        return;
    var hx = other.baddieID.x
    var hy = other.baddieID.y
    if (state == (67 << 0) && sprite_index != spr_playerPZ_Sjumpcancel && sprite_index != spr_playerPZ_mach3hit && character == "P")
    {
        sprite_index = spr_playerPZ_mach3hit
        image_index = 0
    }
    if (state == (67 << 0) && sprite_index != spr_pizzano_mach3 && sprite_index != spr_pizzano_mach3hit && character == "N")
    {
    ...
    if ((!grounded) && state != (71 << 0) && state != (60 << 0) && (sprite_index != spr_dive || character == "N") && (key_jump2 || input_buffer_jump < 8))
    {
        suplexmove = 0
        vsp = -11
    }
